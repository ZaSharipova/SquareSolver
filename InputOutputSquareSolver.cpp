...
int handle_output(int output_choice_result, int number_of_roots, long double result1, long double result2, const char *filename);
...
void output(int output_choice_result, int number_of_roots, long double result1, long double result2, FILE *file);
...
int handle_output(int output_choice_result, int number_of_roots, long double result1, long double result2, const char *filename_to_open_output) {
    assert(filename_to_open_output != NULL);
