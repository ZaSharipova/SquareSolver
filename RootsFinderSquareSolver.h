...
//-----------------------------------------------------------------------------------------------------------------------
int find_linear_root(long double b, long double c, long double *result1);
...
//--------------------------------------------------------------------------------------------------------------------------
int find_quadratic_roots(long double a, long double b, long double c, long double *result1, long double *result2);
